...
(setq doom-font (font-spec :family "LigaPlexMono Nerd Font" :weight 'semibold :size 14))
(setq doom-variable-pitch-font (font-spec :family "IBM Plex Sans" :size 15))
(setq doom-big-font (font-spec :family "LigaPlexMono Nerd Font" :weight 'semibold :size 18))
